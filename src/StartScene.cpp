...
void StartScene::update()
{
	...
	//call collisiongmmanager aabb check pass in planet and ship and mine and ship
...
void StartScene::start()
{
	...
	m_pPlanet->setPosition(glm::vec2(300.0f, 100.0f));

	//Mine
	m_pMine = new Mine();
	m_pMine->setPosition(glm::vec2(300.0f, 300.0f));
}
